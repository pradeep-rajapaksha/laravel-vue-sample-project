...
use App\Service\ClientService as Client;

class MediumService
{
	const MEDIUM_CLIENT_KEY = 'f6c8311e0de9';
	const MEDIUM_SECRET_KEY = '929534fec99333e337d4f25c75742fc2b22a696b';
	const MEDIUM_STATE = 'DG52PR&u@MAq';
